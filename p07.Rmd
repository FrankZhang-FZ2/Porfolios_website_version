...
DGS_6model_1 <- DGS %>%
  select(c(DGS_12,DGS_15,DGS_17,DGS_18,DGS_19,DGS_30,DGS_32,DGS_33,DGS_34,DGS_36,DGS_56,DGS_49,DGS_57,DGS_58,DGS_60,DGS_61,DGS_63,DGS_75))
DGS_6model_2 <- DGS %>%
...
DGS_6model_6 <- DGS %>%
  select(c(DGS_6,DGS_38,DGS_39,DGS_70,DGS_71))

#2 factors 
DGS_2model_2 <- DGS%>%
  select(c(DGS_28,DGS_35,DGS_48,DGS_68,DGS_6,DGS_38,DGS_39,DGS_70,DGS_71))
...
visu_likert(DGS_6model_2)#Reasoning of norm
visu_likert(DGS_6model_3)#Extreme empathy
visu_likert(DGS_6model_4)#Effective giving
visu_likert(DGS_6model_5)#Attitudes toward social changes
visu_likert(DGS_6model_6)#Universality

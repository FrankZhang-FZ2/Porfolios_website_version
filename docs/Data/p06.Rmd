...
```{r 2factors_check}
#Explore higher level structure
DGS_fit_2C <- DGS %>%
  select(c(
    DGS_12,DGS_15,DGS_17,DGS_18,DGS_19,DGS_30,DGS_32,DGS_33,DGS_34,DGS_36,DGS_56,DGS_49,DGS_57,DGS_58,DGS_60,DGS_61,DGS_63,DGS_75,
    DGS_5,DGS_10,DGS_26,DGS_41,DGS_54,DGS_69,DGS_72,
...
EFA_fit_2C
print(EFA_fit_2C$loadings, cutoff = 0.3)


#fit
EFA_fit_2C$rms  # Root mean square of the residuals (lower the better)
EFA_fit_2C$RMSEA # root mean squared error of approximation (lower the better)
EFA_fit_2C$TLI  # tucker lewis index
1- ((EFA_fit_2C$STATISTIC-EFA_fit_2C$dof)/
      (EFA_fit_2C$null.chisq-EFA_fit_2C$null.dof))  #CFI
```

###CFA for testing a hierartical structure
...
parameterestimates(DGS_2M_fit,
                   standardized = TRUE)

fitmeasures(DGS_2M_fit)
...
model_parameters(DGS_2M_fit, standardize = TRUE)
```